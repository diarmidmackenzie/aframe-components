...
/* harmony import */ var three_examples_jsm_lines_LineSegments2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! three/examples/jsm/lines/LineSegments2.js */ "./node_modules/super-three/examples/jsm/lines/LineSegments2.js");
/* harmony import */ var three_examples_jsm_lines_LineGeometry_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! three/examples/jsm/lines/LineGeometry.js */ "./node_modules/super-three/examples/jsm/lines/LineGeometry.js");
/* harmony import */ var three_examples_jsm_lines_LineMaterial_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! three/examples/jsm/lines/LineMaterial.js */ "./node_modules/super-three/examples/jsm/lines/LineMaterial.js");
/* harmony import */ var _dash_pattern_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dash-pattern.js */ "./dash-pattern.js");
/* harmony import */ var _line_math_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./line-math.js */ "./line-math.js");
/* global AFRAME */
//
...
const _rcLine = new three__WEBPACK_IMPORTED_MODULE_0__.Line3();
const _rcPoint = new three__WEBPACK_IMPORTED_MODULE_0__.Vector3();
const _rcPointOnLine = new three__WEBPACK_IMPORTED_MODULE_0__.Vector3();

// Stock LineSegments2 raycast — delegated to for the `px` (screen-space) path.
const _stockRaycast = three_examples_jsm_lines_LineSegments2_js__WEBPACK_IMPORTED_MODULE_2__.LineSegments2.prototype.raycast;
...
AFRAME.registerComponent('connecting-line2', {
  ...
  init() {
    ...
    // never per-overlay.
    this.lineGeometry = new three_examples_jsm_lines_LineGeometry_js__WEBPACK_IMPORTED_MODULE_3__.LineGeometry();
  ...
  // geometry, and attach the custom .raycast. Added to the el's object3D so
  // A-Frame's raycaster (which traverses object3D descendants) finds it.
  createPickLine() {
    ...
    const material = new three_examples_jsm_lines_LineMaterial_js__WEBPACK_IMPORTED_MODULE_4__.LineMaterial({ linewidth: 1 });
    const pickLine = new three_examples_jsm_lines_Line2_js__WEBPACK_IMPORTED_MODULE_1__.Line2(this.lineGeometry, material);
    pickLine.visible = false;          // pick-only; never drawn.
    pickLine.frustumCulled = false;    // must be raycastable even when off-screen-culled.
    pickLine.userData.clPickLine = true;
    // A-Frame's raycaster keeps only intersections whose object has an `.el`
    // back-reference (raycaster.js: `if (intersection.object.el)`). Objects
    // added to el.object3D via plain .add() (rather than setObject3D) don't get
    // it, so set it explicitly — otherwise every hit on the pick line is
    // silently discarded.
    pickLine.el = this.el;
    ...
    if (this.el && this.el.object3D) this.el.object3D.add(pickLine);
  },
  ...
  raycastWorldDistance(line, raycaster, intersects) {
    ...
    const threshold = (raycaster.params.Line2 && raycaster.params.Line2.threshold) || 0;
  ...
  disposePickLine() {
    if (!this.pickLine) return;
    if (this.el && this.el.object3D) this.el.object3D.remove(this.pickLine);
    if (this.pickLine.material) this.pickLine.material.dispose();
    this.pickLine.el = null;
    this.pickLine = null;
  },
  ...
  resolveDashOverlays() {
    ...
    const sanitised = (0,_dash_pattern_js__WEBPACK_IMPORTED_MODULE_5__.sanitiseDash)(data.dash, this.attrName);
    const userDashOffset = Number.isFinite(data.dashOffset) ? data.dashOffset : 0;
    const newParams = (0,_dash_pattern_js__WEBPACK_IMPORTED_MODULE_5__.decomposeDash)(sanitised, userDashOffset);
  ...
  rebuildOverlays(count) {
    ...
    for (let i = 0; i < count; i++) {
      const material = new three_examples_jsm_lines_LineMaterial_js__WEBPACK_IMPORTED_MODULE_4__.LineMaterial({
  ...
  onBeforeRender(renderer, scene, camera, geometry, material /*, group */) {
    ...
    const wpp = (0,_line_math_js__WEBPACK_IMPORTED_MODULE_6__.worldPerPixel)(cam, viewportHeightPx, _midpointWorld);
    ...
    const period = (0,_dash_pattern_js__WEBPACK_IMPORTED_MODULE_5__.getPeriod)(this.overlayParams);
    if (period > 0) {
